...
<html lang="en">
   ...
   <body>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="blog-post date-style-2">
                              <div class="wt-post-media wt-img-effect zoom-slow">
                                 <a href="javascript:;"><img src="images/blog/default/portrait/blog.png" alt=""></a>
                              </div>
                              <div class="wt-post-info bg-white p-t30">
                                 <div class="wt-post-meta ">
                                    <ul>
                                       <li class="post-category"><span>Blog 1</span> </li>
                                       <li class="post-date">Date & Time</li>
                                    </ul>
                                 </div>
                                 <div class="wt-post-title ">
                                    <h3 class="post-title"><a href="javascript:;" class="site-text-secondry">Description
                                       </a>
                                    </h3>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="blog-post date-style-2">
                              ...
                              <div class="wt-post-info bg-white p-t30">
                                 <div class="wt-post-meta ">
                                    <ul>
                                       <li class="post-category"><span>Blog 2</span> </li>
                                       <li class="post-date">Date & Time</li>
                                    </ul>
                                 </div>
                                 <div class="wt-post-title ">
      ...
      <style type="text/css">
          ...
          .date-style-2 .wt-post-meta ul li.post-date, .date-style-2 .wt-post-readmore a{
